    ...
    return (
        <div className={s.footer_header}>
            <div className={s.footer_header_header}>
                ...
                <p>Ми пишаємося своєю піцою. Це, без перебільшення, витвір <br/> мистецтва. Тож ділимося з Вами
                    найбільшою таємницею: як ми це <br/> робимо.</p>
            </div>
            ...
            <div className={s.footer_header_wave}>
